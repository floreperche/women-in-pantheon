...
<div class="graph-container bee">
  ...
  <div class="legend">
    <svg {width} height={marginHeight}>
      <g transform="translate({width / 2 - 200} 25), scale({1.4})">
        <Flower
      ...
      >
      <g transform="translate({width / 2 - 100} 25), scale({1.4})">
        <Flower
        ...
        ></g
      >
      <g transform="translate({width / 2 + 150} 25), scale({1.4})">
  ...
  >
    <svg {height} {width}>
      ...
      {#each nodes as person, index}
        ...
        >
          <Flower {person} shape={"center"} {hovered} />
        </g>
      {/each}
    </svg>
    {#if hovered}
